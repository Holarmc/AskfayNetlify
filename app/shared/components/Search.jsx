  ...
  return (
    <Form className="relative w-full flex flex-row gap-2 shadow-md mt-2 mb-12">
      <div className="w-10/12 ">
        ...
        <input
          class="block w-full focus:ring-2 focus:ring-pink-200 focus:outline-none appearance-none text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-l-md py-3 pl-10"
          type="text"
      ...
      <div className="flex w-2/12 gap-1">
        ...
        <input
          type="submit"
          value="Search"
          className="flex-1 w-3/5 rounded-r-md bg-pink-200 text-light text-sm leading-6 hover:bg-pink-300 transition ease-in-out active:scale-95 active:bg-pink-300 "
        />
      </div>
    </Form>
  );
