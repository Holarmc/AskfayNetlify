...
const Footer = () => {
  return (
    <footer className="static bottom-0 left-0 bg-light p-2 ">
      <div className="flex flex-col md:flex-row justify-between">
        <div className="justify-center items-left p-2 ">
          <div className="font-black text-pink">AskFAY</div>
          <div>
            <p className="p-x-4 text-black01 font-normal text-sm max-w-52">
        ...
        <div className="justify-center items-left p-2">
          <div className="font-medium text-black60">INFROMATION</div>
          <div>
            <p className="p-x-4 text-black01 font-normal text-sm">
              <ul>
                <li>About us</li>
                <li>Services</li>
                <li>Products</li>
        ...
        <div className="justify-center items-left p-2">
          <div className="font-medium text-black60">HELPFUL LINKS</div>
          <div>
            <p className="p-x-4 text-black01 font-normal text-sm">
              <ul>
                <li>FAQ</li>
        ...
        <div className="justify-center items-left p-2">
          <div className="font-medium text-black60 pb-2">CONTACT US</div>
          <div>
        ...
        <div className="justify-center items-left p-2">
          <div className="hidden md:block font-medium text-black60">
            Language
          </div>
...
export default function App() {
  return (
    <html lang="en">
      ...
      <body className="container  mx-auto bg-gray font-inter my-2">
        <div className="grid-container relative container max-w-screen-xlg px-2">
          {/* max-w-screen-xlg */}
          <Header />
          <Outlet />
          <Footer />
